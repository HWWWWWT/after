...
<link href='../language/<?php echo $GLOBALS["sLanguage"]?>.css' type='text/css' rel='stylesheet'>
<link href='../dialog/dialog.css' type='text/css' rel='stylesheet'>
</head>
<body class=upload>

<form action="?action=save&type=<?php echo $GLOBALS["sType"]?>&style=<?php echo $GLOBALS["sStyleName"]?>&language=<?php echo $GLOBALS["sLanguage"]?>" method=post name=myform enctype="multipart/form-data">
<INPUT TYPE="hidden" name="MAX_FILE_SIZE" value="<?php echo ($GLOBALS["nAllowSize"]*1024);?>">
<input type=file name="uploadfile" size=1 style="width:100%">
</form>

<script language=javascript>

var sAllowExt = "<?php echo $GLOBALS["sAllowExt"]?>";
