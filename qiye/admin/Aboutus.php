...
if($mark=="del")
{
	$sql="delete from qiyeinfo where id=$id";
            ...
            <div align="center">
              <table width="100%" height="62" border="0" align="center" cellpadding="0" cellspacing="1" class="tang_southidc">
                <tr bgcolor="#ECF5FF" class="title">
                  ...
                  <td width="265" height="29" align="center"><strong>企业信息名称</strong></td>
                  <td width="108" align="center"><strong> 操作</strong></td>
                </tr>
<?php
$sql="select * from qiyeinfo order by id DESC";
$result=mysql_query($sql);
$i=0;
...
?>
                <tr class="tdbg">
                  ...
                  <td align="center" bgcolor="#ECF5FF">
                    ...
                    &nbsp;<a href="AboutusModify.php?id=<?php echo $data[id]?>">修改</a>&nbsp;
