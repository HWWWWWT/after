...
$addtime=date("Y-m-d");
$sql="insert into anli (title,content,addtime,shenhe,pic) values ('$title','$content','$addtime','$shenhe','$pic')";
$result=mysql_query($sql);
if($result)
{
	echo "<script language=JavaScript>{window.alert('添加成功！');window.location.href='anli.php'}</script>";
}
else
{
exit ("失败了");
...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" valign="top"> <br> <table width="560" border="0" cellpadding="2" cellspacing="1" class="table_southidc">
        ...
        <tr>
          <form method="post" name="myform" action="?mark=save" enctype="multipart/form-data">
            <td><div align="center">
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                  <tr bgcolor="#ECF5FF">
                    <td width="16%" height="23" bgcolor="#ECF5FF"> <div align="center">成功案例名称:</div></td>
                    <td width="34%" height="25"> <input type="text" name="title" class="inputtext" maxlength="100" size="45">
                    </td>

                  </tr><tr>
                  <td bgcolor="#A4B6D7"><div align="center">缩略图： </td>
                  <td width="214" height="21" bgcolor="#E3E3E3"> <input name="pic" type="file" id="pic" size="30" maxlength="50">
                  </td>

                </tr>
                  <tr bgcolor="#ECF5FF">
                    <td height="25" colspan="6"><div align="left">成功案例内容</div></td>
                  </tr>
                  <tr bgcolor="#ECF5FF">
